...
export default function ClassModeContainer({
    ...
    const { userRole, firstName, lastName, uid } = useUserRole();
    ...
    useEffect(() => {
        // This function handles creating the WebSocket connection for students
        const joinLearner = () => {
            if (ws) {
            ...
            ////bbbbbbbbbbb (learners, joinLearner)
