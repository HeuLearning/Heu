...
import { AssessmentHistory } from "models/assessment-history";
...
const getAssessmentQuestion = async (
  ...
  try {
    ...
    const config: AxiosRequestConfig = {
      url: `http://localhost:8000/api/get-assessment-question`,
      method: "POST",
      headers: {
...
export default withApiAuthRequired(getAssessmentQuestion);