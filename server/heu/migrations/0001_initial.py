# Generated by Django 4.2.4 on 2024-08-09 15:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questions', models.ManyToManyField(related_name='module_question_counter', to='heu.hardcodedquestioncounter')),
            ],
        ),
        migrations.CreateModel(
            name='ModuleCounter',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructors', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), blank=True, default=list, null=True, size=None)),
                ...
                ('lesson_plan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='heu.lessonplan')),
            ],
        ),
        migrations.CreateModel(
            name='StudentData',
        ...
        migrations.AddField(
            ...
            name='phases',
            field=models.ManyToManyField(related_name='phase_counter', to='heu.phasecounter'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intermediate_answers', django.contrib.postgres.fields.ArrayField(base_field=models.TextField(), blank=True, default=list, null=True, size=None)),
                ('intermediate_timing', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), blank=True, default=list, null=True, size=None)),
        ...
        migrations.AddField(
            ...
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='heu.question'),
        ),
        migrations.CreateModel(
            name='HardCodedModule',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('questions', models.ManyToManyField(related_name='hardcoded_module_question_counter', to='heu.hardcodedquestioncounter')),
            ],
        ),
        migrations.AddField(
